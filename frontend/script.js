...
var translations = {
    fr: {
        ...
        'apropos.cta': 'Contactez-nous',
        'faq.title': 'Questions fréquentes',
        'faq.subtitle': "Tout ce qu'il faut savoir avant de nous confier votre événement",
        'faq.q1': 'Depuis combien de temps Virgina Decoration exerce-t-elle ?',
        'faq.a1': 'Nous organisons et décorons des événements en Haïti depuis plusieurs années, avec une équipe passionnée qui a accompagné de nombreuses familles et entreprises dans la réalisation de leurs moments les plus précieux.',
        'faq.q2': "Combien de temps à l'avance faut-il réserver vos services ?",
        'faq.a2': "Nous recommandons de nous contacter au moins 2 à 4 semaines avant la date de votre événement pour garantir la disponibilité de l'équipe et préparer chaque détail avec soin. Pour les demandes de dernière minute, contactez-nous quand même — nous ferons notre possible.",
        'faq.q3': 'Intervenez-vous partout en Haïti ou seulement à Port-au-Prince ?',
        'faq.a3': 'Nous intervenons principalement dans la zone métropolitaine de Port-au-Prince et ses environs (Pétion-Ville, Delmas, etc.), mais nous étudions également les demandes pour d\'autres départements et villes selon le projet.',
        'faq.q4': 'Comment se déroule une demande de devis ?',
        'faq.a4': 'Remplissez notre formulaire de contact en ligne ou écrivez-nous directement sur WhatsApp en nous précisant la date, le lieu, le nombre d\'invités et le thème envisagé. Nous vous répondons sous 24h avec une proposition sur mesure adaptée à votre budget.',
        'faq.q5': 'Proposez-vous des décorations sur mesure selon un thème ou un budget précis ?',
        'faq.a5': 'Absolument ! Chaque création est personnalisée selon votre style, votre palette de couleurs et votre budget. Nous collaborons étroitement avec vous pour concevoir une ambiance raffinée et mémorable.',
    ...
    ht: {
        ...
        'apropos.cta': 'Kontakte Nou',
        'faq.title': 'Kesyon yo poze souvan',
        'faq.subtitle': 'Tout sa ou bezwen konnen anvan ou konfye nou evènman ou an',
        'faq.q1': 'Depi konbyen tan Virgina Decoration ap bay sèvis ?',
        'faq.a1': 'Nou òganize epi dekore evènman an Ayiti depi plizyè ane, ak yon ekip pasyone ki deja akonpanye anpil fanmi ak antrepriz.',
        'faq.q2': 'Konbyen tan davans li nesesè pou rezève sèvis nou yo ?',
        'faq.a2': 'Nou rekòmande kontakte nou omwen 2 a 4 semèn anvan dat evènman an pou garanti disponiblite ekip la. Pou ijans, kontakte nou kanmenm.',
        'faq.q3': 'Èske nou travay tout kote an Ayiti oubyen sèlman Pòtoprens ?',
        'faq.a3': 'Nou travay sitou nan zòn metwopolitèn Pòtoprens (Petyonvil, Dèlma, elatriye), men nou etidye demand pou lòt vil ak depatman tou.',
        'faq.q4': 'Kijan yon demand devi fèt ?',
        'faq.a4': 'Ranpli fòmilè kontak sou sit la oswa ekri nou sou WhatsApp avèk dat, kote, kantite moun ak tèm ou vle a. N ap reponn ou anba 24h.',
        'faq.q5': 'Èske nou fè dekorasyon pèsonalize selon yon tèm oswa bidjè presi ?',
        'faq.a5': 'Wi, tout dekorasyon fèt sou mezi selon gou ou, koulè ou chwazi yo ak bidjè ou genyen.',
    ...
    en: {
        ...
        'apropos.cta': 'Contact Us',
        'faq.title': 'Frequently Asked Questions',
        'faq.subtitle': 'Everything you need to know before booking your event',
        'faq.q1': 'How long has Virgina Decoration been operating?',
        'faq.a1': 'We have been organizing and decorating events in Haiti for several years, with a dedicated team having served numerous families and businesses.',
        'faq.q2': 'How far in advance should we book your services?',
        'faq.a2': 'We recommend booking at least 2 to 4 weeks prior to your event date to secure our team. For last-minute requests, feel free to contact us anyway.',
        'faq.q3': 'Do you operate across all Haiti or only Port-au-Prince?',
        'faq.a3': 'We operate mainly in the Port-au-Prince metropolitan area (Petion-Ville, Delmas, etc.), and we also consider requests for other cities depending on the project.',
        'faq.q4': 'How do I request a quote?',
        'faq.a4': 'Fill out our online contact form or message us directly on WhatsApp with your event date, location, guest count and theme. We reply within 24h.',
        'faq.q5': 'Do you offer customized decorations based on specific themes or budgets?',
        'faq.a5': 'Absolutely! Every decoration is tailored to your taste, color scheme and budget without compromising on elegance.',
